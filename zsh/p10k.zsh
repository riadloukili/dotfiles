# Generated by Powerlevel10k configuration wizard on 2025-10-04 at 11:22 EDT.
...
# 12h time, slanted separators, slanted heads, slanted tails, 2 lines, disconnected,
...
# Prompt segment: icon coloured by $CLOUD_PROVIDER (set per host by nixos-config).
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    cloud_provider_icon     # host location icon (nixos-config)
    # =========================[ Line #1 ]=========================
